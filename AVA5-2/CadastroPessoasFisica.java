/* Classe CadastroPessoasFisica.java para a forma de cadastro de pessoas físicas a partir da Superclasse polifórmica Cadastro.java */
 
import javax.swing.*;
import java.awt.*;

public class CadastroPessoasFisica extends Cadastro {

    public CadastroPessoasFisica(JFrame principal) {
        super(principal);
    }
